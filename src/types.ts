...
export interface ChannelMessage {
  ...
  /** Token usage statistics by model name (only present on agent messages). */
...
export interface StreamEvent {
  ...
  content_blocks?: ContentBlock[];
  /** Accumulated token usage by model name (e.g. "claude-sonnet-4-6"). Only present on is_done. */
  token_usage?: Record<string, TokenUsage>;
}
