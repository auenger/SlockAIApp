    ...
    <div className="w-80 h-full bg-white brutal-border-l flex flex-col">
      ...
      <div className="p-3 brutal-border-b flex items-center justify-between bg-gray-50">
        <div className="font-black text-sm truncate">
          Thread &mdash; <span className="text-gray-500">#kagent-integrate-sap-ai-core</span>
        </div>
  ...
  labels:
    ...
    region: eu`}</pre>
        ...
        <div className="space-y-2">
          <h4 className="font-black text-xs italic">Summary</h4>
          <div className="brutal-border overflow-hidden">
            <table className="w-full text-[10px] border-collapse">
              <thead>
                <tr className="bg-brutal-cyan brutal-border-b">
                  <th className="p-1 text-left brutal-border-r">Aspect</th>
                  <th className="p-1 text-left">kubectl-mcp-server + kubeconfig</th>
                </tr>
              </thead>
              <tbody>
                <tr className="brutal-border-b">
                  <td className="p-1 brutal-border-r bg-gray-100">Architecture</td>
                  <td className="p-1">Single point multi-connection</td>
                </tr>
                <tr className="brutal-border-b">
                  <td className="p-1 brutal-border-r bg-gray-100">Fault Isolation</td>
                  <td className="p-1">Single point of failure</td>
                </tr>
                <tr className="brutal-border-b">
                  <td className="p-1 brutal-border-r bg-gray-100">Scalability</td>
                  <td className="p-1">Limited</td>
                </tr>
              </tbody>
            </table>
          </div>
